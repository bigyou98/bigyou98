...
### 오픈 소스를 통해 서로 정보 공유를 하며 상생하는 개발 문화를 사랑합니다.

대학교 웹 개발 동아리 감자에서 부회장과 [프로젝트](https://github.com/potato-club/temperature-outfit) 리더를 맡아 지식을 공유하고 코드 리뷰를 해준 경험이 있고 [기술 블로그](https://bigyou98.tistory.com/)를 운영하며 지식을 공유하고 있습니다.
